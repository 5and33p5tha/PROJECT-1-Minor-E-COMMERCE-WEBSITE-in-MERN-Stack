...
import { signupfrombackendtofrontend } from "../Components/Auth/index";
// OR:-
...
const Signup = () => {
  ...
  const showError = () => {
    ...
    if (error) {
      ...
      //   <div className="alert alert-danger">{error}</div>; //alert alert-danger is from bootstrap
